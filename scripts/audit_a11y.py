...
Run from the econ201 folder:  python3 scripts/audit_a11y.py [folder]   (or: make audit)
...
# An optional argument audits a different folder, e.g. the temp render.
DOCS = pathlib.Path(sys.argv[1]).resolve() if len(sys.argv) > 1 else ROOT / "docs"
