...
Take the option whose benefit beats its economic cost. The old press costs $165,000 against a $150,000 benefit, so it fails; the new press costs $135,000 against the same benefit, so it passes. **She leases the new press**, which is what comparing net benefits says too: $45,000 beats $30,000.
