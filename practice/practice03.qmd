...
**(a)** Draw a table with a column for each option, and fill in the benefit, the direct cost, and the net benefit of each.
...
**(b)** Add a row for the opportunity cost of each option. Lena can run only one press.

<details class="solution">
<summary>Solution</summary>

The opportunity cost of an option is what Lena gives up by choosing it, which is the net benefit of the next best alternative. With only two options, each one's opportunity cost is the other's net benefit.
...
**(c)** Add a row for the economic cost of each option, and compare it with that option's benefit. Which press does Lena choose?
