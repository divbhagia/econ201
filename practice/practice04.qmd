...
**(b)** Now suppose the price falls to a quarter of a loaf per pound. What happens?
...
**(c)** In the lecture, the deal was 2 pounds for 2 loaves, a price of 1 loaf per pound. Compare that with the 1.5-loaf price in part (a). Whose share of the gains from trade grew?
...
Luis and Kim each run a food truck. If each spent a whole workday on just one product, they could make:
...
| Kim | 12 / 6 = 2 tacos | 6 / 12 = 0.5 burritos |
...
**Luis has the absolute advantage in both** (40 tacos against 12, and 8 burritos against 6). But a burrito costs Kim only 2 tacos against Luis's 5, so **Kim has the comparative advantage in burritos**, and a taco costs Luis 0.2 burritos against Kim's 0.5, so **Luis has the comparative advantage in tacos**.

</details>

**(c)** On their own, Luis spends three quarters of the day on tacos and Kim spends two thirds of the day on tacos. How much does each produce, and what are the totals?
...
Luis makes only tacos, 40 of them, and Kim makes only burritos, 6 of them. Compared with 38 tacos and 4 burritos under self-sufficiency, specialization yields **2 more tacos and 2 more burritos** from the same two people and the same hours.

</details>

**(e)** They agree on a deal: Kim sells Luis 3 burritos for 9 tacos. What does each of them end up with, and is each better off than in part (c)?
...
- Kim: the **9 tacos** she received and 6 − 3 = **3 burritos**, against 8 and 2 on her own. Better off.
...
Kim sells only above her own cost of a burrito, 2 tacos; Luis buys only below his, 5 tacos. Any price **between 2 and 5 tacos per burrito** leaves both better off, which is why the deal at 3 worked.
