...
::: {.fragment}
Note: When comparing countries, GDP is converted so that \$20 buys what \$20 buys in the US (*purchasing power parity*).
:::
:::
...
- According to him, prosperity came from the *division of labor/specialization*, which is limited by the *extent of the market*.
  - Pin factory example: ten workers, each doing one or two of 18 steps, made close to 50,000 pins a day. Working alone, barely one each.
...
::: {.takeaway}
How did a world in which living conditions barely changed become one of continuous technological revolution, with each generation noticeably better off than the last?
:::

::: {.fragment}
A big part of the answer is the *capitalist revolution*: the emergence in the eighteenth century, and eventual global spread, of a new way of organizing the economy that we now call *capitalism*.
:::
...
- To find out, economists look for a *natural experiment*: a situation in which similar people or places end up under different conditions by chance, so that the outcomes can be compared
- The division of Germany after the Second World War is one. The same people, with the same history, were split into a capitalist West and a centrally planned East

## Central Planning versus Capitalism

![](img/germanies.svg){fig-alt="GDP per capita in West Germany and East Germany from 1950 to 1989, in 1990 international dollars. Both start near $2,000 to $4,000 in 1950. West Germany rises steadily to about $18,000 by 1989; East Germany rises more slowly to about $8,000. The gap widens every decade."}
...
- *Institutions and politics*: not all capitalist economies are equally successful. Private property, markets, or firms may fail, and governments differ in how well they regulate them and provide essential public goods such as infrastructure and education
...
::: {.takeaway}
*Economics* is the study of how people interact with each other and with their natural environment in producing their livelihoods, and how this changes over time and differs across societies.
:::
...
- Read sections 1.2, 1.5, and 1.8 closely; you can skim the rest of the assigned reading. 
- Go over the slides; a short summary of today will also be posted.
- Work on the practice questions and finish the worksheet. 
- *Quiz 1 is Monday*, on today's material
